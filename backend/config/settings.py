...
GDAL_LIBRARY_PATH = r"C:\Program Files\QGIS 3.42.0\bin\gdal310.dll"
GEOS_LIBRARY_PATH = r"C:\Program Files\QGIS 3.42.0\bin\geos_c.dll"
PROJ_LIB = r"C:\Program Files\QGIS 3.42.0\share\proj"
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('DB_PASSWORD', 'sid456'),
...
# Media files
MEDIA_URL = 'media/'
MEDIA_ROOT = r'D:\sylvix_media'
FILE_UPLOAD_TEMP_DIR = r'D:\sylvix_media\tmp'
